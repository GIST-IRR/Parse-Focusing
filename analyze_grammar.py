...
def main(args):
    ...
    path = args.model_paths \
        if isinstance(args.model_paths, list) else [args.model_paths]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--config', default='log/n_english_std_norig/NPCFG2022-12-27-17_31_28/config.yaml')
    parser.add_argument('--model_paths', nargs='+', default='log/n_english_std_norig/NPCFG2022-12-27-17_31_28/last.pt')
