...
class Root_parameterizer(nn.Module):
    def __init__(self, s_dim,  NT) -> None:
        super().__init__()
        self.s_dim = s_dim
        self.NT = NT
...
class Nonterm_parameterizer(nn.Module):
    def __init__(self, s_dim,  NT, T) -> None:
        super().__init__()
        self.s_dim = s_dim
        self.NT = NT
        self.T = T
...
class Term_parameterizer(nn.Module):
    def __init__(self, s_dim, T, V) -> None:
        super().__init__()
        self.s_dim = s_dim
        self.T = T
        self.V = V
...
class ExNTTAGPCFG(PCFG_module):
    def __init__(self, args):
        super(ExNTTAGPCFG, self).__init__()
        self.pcfg = PCFG()
